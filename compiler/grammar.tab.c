...
static const char *const yytname[] =
{
  ...
  "RIGHT_PARENTHESIS", "SINGLECOMMENT", "MULTILINECOMMENT", "SH", "QUOTES",
  "CHARACTERS_BLOCK", "INT", "INTEGER_VALUE", "DECIMAL_VALUE", "LOAD",
  "STDIN", "DOLLAR_SIGN", "INC", "DEC", "DECI", "BLN", "SET", "TR", "FL",
  "ITOB", "QUESTION_MARK", "CORCHOIZ", "CORCHODE", "EQ", "LE", "LT", "GT",
  "GE", "NE", "ELSE", "COMA", "STR", "COLOND", "WHILE", "ANSWER", "MAS",
  "SLASHDO", "MENOS", "SLASH", "SHL", "$accept", "input", "function_list",
